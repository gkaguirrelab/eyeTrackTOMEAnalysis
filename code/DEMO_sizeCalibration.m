...
sizeConversionFileName = fullfile(pathParams.dataOutputDirFull, 'sizeConversion.mat');

% get size calibration values
getSizeConversionFactors(dotDataFilesNames,sizeGroundTruths, sizeConversionFileName)
