        ...
        if strcmp(stageChoice,'6') || strcmp(stageChoice,'7')
            ...
            if sum(irisKeyIdx)==1
                ...
                if sum(sceneParamsX0)==1
                    ...
                    switch length(x0)
                        case 4
                            sceneParamsLB = [x0(1)-10; x0(2:3)-1; x0(4)-cameraDepthSD*0.5; 0.8; 0.9];
                            sceneParamsLBp = [x0(1)-5; x0(2:3)-0.5; x0(4)-cameraDepthSD*0.25; 0.9; 0.95];
                            sceneParamsUBp = [x0(1)+5; x0(2:3)+0.5; x0(4)+cameraDepthSD*0.25; 1.1; 1.05];
                            sceneParamsUB = [x0(1)+10; x0(2:3)+1; x0(4)+cameraDepthSD*0.5; 1.2; 1.1];
                        case 6
                            sceneParamsLB = x0;
                            sceneParamsLBp = x0;
                            sceneParamsUBp = x0;
