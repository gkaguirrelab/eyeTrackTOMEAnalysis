...
fprintf('\t7. Sync sceneGeometry (7)\n');
fprintf('\t8. Scene-constrained pupil fitting (8)\n');
fprintf('\t9. Empirical Bayes smoothing (9)\n');
fprintf('\t10. Generate timebase only (1)\n');
fprintf('\t11. Identify gaze cal frames and targets\n');
fprintf('\t12. Align timebase with liveTrack report\n');
fprintf('\t13. Create a stage 8 fit video\n');
fprintf('\t14. Create a final fit video (10)\n');
fprintf('\t15. Perimeter definition to end, including video (3-6, 8-10)\n');
fprintf('\t16. Control file to end, including video (4-6, 8-10)\n');
fprintf('\t17. Scene-constrained fitting, Bayes, video (8-10)\n');
fprintf('\t18. Scene-constrained fitting, Bayes, No video (8-9)\n');
