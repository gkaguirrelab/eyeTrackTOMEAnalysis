...
customKeyValue1 = {'*ScaleCal*', ...
    'pupilRange', [20 100], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', 1.3,'pupilFrameMask', [2 30]};
customKeyValue2 = {'GazeCal*', ...
    'pupilRange', [30 100], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', .7,...
    'glintFrameMask', [20 50 110 160]};
customKeyValue3 = {'T1*', ...
    'pupilRange', [30 150], 'pupilCircleThresh', 0.03,...
    'glintFrameMask', [20 50 110 160]};
customKeyValue4 = {'T2*', 'pupilRange', [30 150], 'pupilCircleThresh', 0.03, ...
    'glintFrameMask', [20 50 110 160]};
customKeyValue5 = {'rfMRI_REST_*', ...
    'pupilRange', [30 180], 'pupilCircleThresh', 0.03, 'pupilGammaCorrection', .75,'pupilFrameMask', [2 40],...
    'glintFrameMask', [10 80 90 100]};
customKeyValue6 = {'dMRI_*', ...
    'pupilRange', [30 150], 'pupilCircleThresh', 0.03,...
    'glintFrameMask', [20 50 110 160] };
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3; customKeyValue4; customKeyValue5; customKeyValue6};
pupilPipelineWrapper(pathParams, ...
...
customKeyValue1 = {'*Cal*', ...
    'pupilRange', [15 100], 'pupilCircleThresh', 0.03, ...
    'glintFrameMask', [40 80 60 100]};
customKeyValue2 = {'dMRI_*', ...
    'pupilRange', [15 100], 'pupilCircleThresh', 0.03,...
    'glintFrameMask', [40 80 60 100]};
customKeyValue3 = {'rfMRI_REST_*', ...
    'glintFrameMask', [40 80 60 80],...
...
customKeyValue1 = {'*Cal*', ...
    'pupilRange', [10 100], 'pupilCircleThresh', 0.03, ...
    'glintFrameMask', [40 60 60 110]};
customKeyValue2 = {'dMRI_*', ...
    'pupilRange', [10 100], 'pupilCircleThresh', 0.03,...
    'glintFrameMask', [40 60 60 110]};
customKeyValue3 = {'rfMRI_REST_*',...
    'glintFrameMask', [40 60 60 110] ...
    'pupilRange', [10 140], 'pupilCircleThresh', 0.04};
customKeyValue4 = {'T1*', ...
    'glintFrameMask', [40 70 80 100]};
customKeyValue5 = {'T2*', ...
    'glintFrameMask', [40 60 60 110]};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3; customKeyValue4; customKeyValue5};
pupilPipelineWrapper(pathParams, ...
...
customKeyValue1 = {'*Cal*', ...
    'pupilRange', [15 180], 'pupilCircleThresh', 0.05, ...
    'glintFrameMask', [70 60 40 110]};
customKeyValue2 = {'T1*', ...
    'pupilRange', [15 180], 'pupilCircleThresh', 0.05,...
    'glintFrameMask', [70 60 40 110]};
customKeyValue3 = {'T2*',...
...
customKeyValue5 = {'rfMRI_REST_*',...
    'glintFrameMask', [70 60 40 110], ...
    'pupilRange', [40 300], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', .5};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3; customKeyValue4; customKeyValue5};
pupilPipelineWrapper(pathParams, ...
    'lastStage', 'findPupilPerimeter', ...
    'makeFitVideoByName', {'findPupilPerimeter'}, ...
...
customKeyValue1 = {'*Cal*',...
    'pupilCircleThresh', 0.04,...
    'glintFrameMask', [80 80 10 90]};
customKeyValue2 = {'rfMRI_REST_*',...
    'glintFrameMask',  [70 110 40 70], ...
    'pupilCircleThresh', 0.04};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
    'lastStage', 'findPupilPerimeter', ...
...
% TOME_3033 session2
pathParams.subjectID = 'TOME_3033';
pathParams.sessionDate = '041318';
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [20 180], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', 1, ...
    'lastStage', 'findPupilPerimeter', ...
    'makeFitVideoByName', {'findPupilPerimeter'});
