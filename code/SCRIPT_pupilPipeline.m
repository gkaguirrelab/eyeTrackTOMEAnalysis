...
customKeyValue1 = {'rfMRI_REST_*', ...
    'glintFrameMask',[60 100 90 80]*2, ...
    'pupilFrameMask', [40 30]*2, 'pupilRange',[40 100]*2, 'pupilCircleThresh', 0.05, ...
...
customKeyValue3 = {{'dMRI_dir99_PA*','dMRI_dir98*','T1*','T2*'}, ...
    'glintFrameMask',[110 100 70 100]*2, ...
...
customKeyValue4 = {'dMRI_dir99_AP', ...
    'glintFrameMask',[130 100 70 100]*2, ...
    'pupilFrameMask', [40 30]*2, 'pupilRange',[20 100]*2, 'pupilCircleThresh', 0.03, ...
    'ellipseTransparentLB',[0, 0, 300, 0, -0.5*pi]};
...
customKeyValue1 = {{'T1*', 'T2*'}, ...
    'glintFrameMask',[110 110 70 110]*2, ...
    'pupilFrameMask', [40 30]*2, 'pupilRange',[20 100]*2, 'pupilCircleThresh', 0.03, ...
    'ellipseTransparentLB',[0, 0, 300, 0, -0.5*pi]};
customKeyValue2 = {'rfMRI_REST_*', ...
    'glintFrameMask',[85 100 90 80]*2, ...
    'maskBox', [.8 1.5],'pupilGammaCorrection', 1.3, 'pupilRange', [50 150]*2, ...
    'exponentialTauParams', [.25, .25, 10, 1, 1] };
customKeyValue3 = {'dMRI_*', ...
    'glintFrameMask',[100 110 90 110]*2, ...
    'pupilFrameMask', [40 30]*2, 'pupilRange',[20 100]*2, 'pupilCircleThresh', 0.03, ...
    'ellipseTransparentLB',[0, 0, 300, 0, -0.5*pi]};
...
customKeyValue1 = {'rfMRI_REST_AP_run01*', ...
    'glintFrameMask',[70 60 70 120]*2, ...
    'pupilRange', [50 150]*2, 'pupilCircleThresh', 0.07, 'pupilGammaCorrection', 1.1, ...
    'extendBlinkWindow', [5,15], ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue2 = {'rfMRI_REST_PA_run02*', ...
    'glintFrameMask',[70 60 100 120]*2, ...
    'pupilRange', [50 150]*2, 'pupilCircleThresh', 0.07, 'pupilGammaCorrection', 1.1, ...
    'extendBlinkWindow', [5,15], ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue3 = {'rfMRI_REST_AP_run03*', ...
    'glintFrameMask',[70 60 115 120]*2, ...
    'pupilRange', [50 150]*2, 'pupilCircleThresh', 0.08, 'pupilGammaCorrection', 1.1, ...
    'extendBlinkWindow', [5,15], ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue4 = {'rfMRI_REST_PA_run04*', ...
    'glintFrameMask',[40 60 140 120]*2, ...
    'pupilRange', [50 150]*2, 'pupilCircleThresh', 0.08, 'pupilGammaCorrection', 1.1, ...
    'extendBlinkWindow', [5,15], ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue5 = {{'LowResScaleCalibration_3Mm*','LowResScaleCalibration_4Mm*'}, ...
    'pupilFrameMask', [70 50 90 100]*2, 'pupilGammaCorrection',1,'pupilRange',[40 90]*2};
customKeyValue6 = {'LowResScaleCalibration_5Mm*', ...
    'pupilFrameMask', [70 50 70 100]*2, 'pupilGammaCorrection',1,'pupilRange',[40 90]*2};
customKeyValue7 = {{'dMRI_dir98*','T1*','T2*'}, 'skipRun', true, ...
    'glintFrameMask',[90 80 80 90]*2, ...
    'pupilRange', [30 100]*2, 'pupilCircleThresh', 0.05, 'pupilGammaCorrection', 1.3, ...
    'ellipseTransparentLB',[0, 0, 300, 0, -0.5*pi]};
customKeyValue8 = {'dMRI_dir99*', 'skipRun', true,...
    'glintFrameMask',[60 80 100 90]*2 ...
    'pupilRange', [30 100]*2, 'pupilCircleThresh', 0.05, 'pupilGammaCorrection', 1.3, ...
    'ellipseTransparentLB',[0, 0, 300, 0, -0.5*pi]};
...
pupilPipelineWrapper(pathParams, ...
    'useLowResSizeCalVideo',true, 'lastStage', 'findPupilPerimeter', ...
...
customKeyValue1 = {'LowResScaleCal*', ...
    'pupilCircleThresh', 0.02, 'pupilRange', [20 60]*2, 'pupilFrameMask', [60 40]*2,'perimeterColor','r'};
customKeyValue2 = {'rfMRI_REST_*', ...
    'glintFrameMask',[40 100 110 130]*2, ...
    'pupilRange', [30 100]*2, 'pupilGammaCorrection', 1.8, ...
    'exponentialTauParams', [.25, .25, 10, 1, 1], 'likelihoodErrorExponent',[1.25 1.25 2 2 2]};
customKeyValue3 = {'dMRI_*', ...
    'glintFrameMask', [30 110 140 130]*2, ...
    'pupilRange', [30 100]*2, 'pupilCircleThresh', 0.05};
customKeyValue4 = {{'T1*','T2*'}, ...
    'glintFrameMask', [25 110 150 130]*2, ...
    'pupilRange', [30 100]*2, 'pupilCircleThresh', 0.05};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3; customKeyValue4};
pupilPipelineWrapper(pathParams, ...
    'useLowResSizeCalVideo',true, ... % 'skipStage', {'convertRawToGray'},...
...
customKeyValue1 = {'LowResScaleCal*', ...
    'pupilCircleThresh', 0.03,'pupilRange', [20 60]*2, 'pupilFrameMask', [60 40]*2,'perimeterColor','r'};
customKeyValue2 = {'rfMRI_REST_*', ...
    'glintFrameMask', [30 80 90 90]*2, ...
    'pupilRange', [30 100]*2, 'pupilCircleThresh', 0.05, ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue3 = {'GazeCal*', ...
    'glintFrameMask', [40 60 120 100]*2, ...
    'pupilRange', [30 100]*2, 'pupilCircleThresh', 0.05};
...
customKeyValue1 = {'rfMRI_REST_*', ...
    'glintFrameMask', [20 120 80 80]*2, ...
    'pupilRange', [40 100]*2, ...
    'exponentialTauParams', [.25, .25, 10, 1, 1], 'likelihoodErrorExponent',[1.25 1.25 2 2 2]};
customKeyValue2 = {'dMRI_*', ...
    'glintFrameMask',[90 110 50 100]*2, ...
    'pupilFrameMask', [50 50]*2, 'pupilRange', [30 100]*2, ...
    'cutErrorThreshold',12, ...
    'ellipseTransparentLB',[0, 0, 300, 0, -0.5*pi]};
customKeyValue3 = {{'T1*','T2*'}, ...
    'glintFrameMask',[120 110 70 100]*2, ...
    'pupilFrameMask', [50 50]*2, 'pupilRange', [30 100]*2, ...
    'cutErrorThreshold',12, ...
    'ellipseTransparentLB',[0, 0, 300, 0, -0.5*pi]};
customKeyValue4 = {'*ScaleCal*', ...
...
customKeyValue1 = {'rfMRI_REST_*','skipRun', true,...
...
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3; customKeyValue4; customKeyValue5; customKeyValue6; customKeyValue7; customKeyValue8};
pupilPipelineWrapper(pathParams, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'convertRawToGray','findPupilPerimeter'}, ...
    'customKeyValues', customKeyValues);
...
customKeyValue2 = {'rfMRI_REST_PA_run02*', ...
    ...
    'glintZoneRadius', 50, ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue3 = {{'rfMRI_REST_AP_run03*','rfMRI_REST_PA_run04*'}, 'skipRun',true,...
    'glintFrameMask', [20 50 140 100],'glintGammaCorrection',3.5 ...
    'maskBox', [.8 1.5],'pupilGammaCorrection', 1.3, 'pupilRange', [50 150], ...
    'glintZoneRadius', 50, ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue4 = {'GazeCal*','skipRun',true, ...
    'glintFrameMask', [10 70 110 100]};
customKeyValue5 = {{'dMRI_*','T2*','T1*'},'skipRun',true, ...
    'glintFrameMask',[10 70 110 100],...
    'pupilRange', [40 150]};
...
customKeyValue1 = {{'T1*','T2*','dMRI*'}, ...
    'glintFrameMask', [80 80 110 130], 'glintGammaCorrection',3, ...
    'pupilRange', [40 120], 'pupilCircleThresh', 0.07};
customKeyValue2 = {'rfMRI_REST_*', ...
    'glintFrameMask', [70 100 110 80], ...
    'pupilRange', [50 150], 'pupilCircleThresh', 0.06, 'glintGammaCorrection',3, ...
