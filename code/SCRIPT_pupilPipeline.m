...
pupilPipelineWrapper(pathParams, ...
    ...
    'makeCustomVideoAtTheEnd', {'findGlint','findPupilPerimeter'},...
...
pupilPipelineWrapper(pathParams, ...
    'useLowResSizeCalVideo',true, ... % 
    'skipStage', {'deinterlaceVideo'},'lastStage','findPupilPerimeter', ...
    'makeCustomVideoAtTheEnd', {'findGlint','findPupilPerimeter'},...
    'customKeyValues', customKeyValues);
...
customKeyValue1 = {{'T1*','T2*','dMRI*'}, ...
    ...
    'pupilRange', [30 120], 'pupilCircleThresh', 0.07,...
    'cutErrorThreshold',13};
customKeyValue2 = {'rfMRI_REST_*', ...
    'glintFrameMask', [70 100 110 80], ...
    'pupilRange', [50 150], 'pupilCircleThresh', 0.06, 'glintGammaCorrection',3.5, ...
...
customKeyValue1 = {'*Cal*', ... 
    pupilRange', [20 140], 'pupilCircleThresh', 0.02, 'pupilGammaCorrection', .5};
customKeyValue2 = {'tfMRI_*', ...
    'pupilRange', [30 240], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
...
customKeyValue1 = {'RawScaleCal*', ...
    'pupilRange', [30 250], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', .75, ...
    'ellipseTransparentLB',[0, 0, 500, 0, -0.5*pi],'perimeterColor','r'};
customKeyValue2 = {'GazeCal*', ...
    'pupilRange', [30 260], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', 0.75};
customKeyValue3 = {'tfMRI_*', ...
    'pupilRange', [30 260], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3};
pupilPipelineWrapper(pathParams, ...
    'lastStage', 'findPupilPerimeter', ...
    'makeFitVideoByName', {'findPupilPerimeter'}, ...
...
customKeyValue1 = {'*Cal*', ...
    'pupilRange', [30 250], 'pupilCircleThresh', 0.05, 'pupilGammaCorrection', .75};
customKeyValue2 = {'tfMRI_*', ...
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [30 280], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', .75, ...
    'lastStage', 'findPupilPerimeter', ...
    'makeFitVideoByName', {'findPupilPerimeter'});
...
customKeyValue1 = {'RawScaleCal*', ...
    'pupilRange', [20 200], 'pupilCircleThresh', 0.03, 'pupilGammaCorrection', .7};
customKeyValue2 = {'GazeCal*', ...
    'pupilRange', [20 250], 'pupilCircleThresh', 0.03, 'pupilGammaCorrection', .75};
customKeyValue3 = {'tfMRI_*', ...
    'pupilRange', [20 250], 'pupilCircleThresh', 0.03, 'pupilGammaCorrection', .75};
