...
customKeyValue1 = {'rfMRI_REST_*', ...
    ...
    'pupilFrameMask', [40 30]*2, 'pupilRange',[80 200], 'pupilCircleThresh', 0.05, ...
...
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'deinterlaceVideo'}, 'lastStage','findGlint', 'makeCustomVideoAtTheEnd', {'findGlint','findPupilPerimeter'},...
