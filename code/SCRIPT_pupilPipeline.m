...
customKeyValue1 = {'RawScaleCal*', 'pupilRange', [20 150], 'pupilCircleThresh', 0.04, 'pupilGammaCorrection', .7,'frameMask', [60 40],'exponentialTauParams',[100 100 100 100 100],'skipRun',true};
...
customKeyValue6 = {'rfMRI_REST_*', 'pupilRange', [40 250], 'pupilCircleThresh', 0.06, 'pupilGammaCorrection', 1,'glintGammaCorrection', 6.5,'cutErrorThreshold', 15};
