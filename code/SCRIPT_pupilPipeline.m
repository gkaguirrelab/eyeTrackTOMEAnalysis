...
pupilPipelineWrapper(pathParams, ...
    ...
    'lastStage', 'findPupilPerimeter', 'skipStageByNumber', 1,...
    'makeFitVideoByName', {'findPupilPerimeter'}, ...
    'customKeyValues', customKeyValues);
...
customKeyValue2 = {'dMRI_*', ...
    ...
    'pupilFrameMask', [50 50], 'pupilRange', [30 100]*2, ...
...
customKeyValue1 = {'rfMRI_REST_*', ...
    ...
    'pupilFrameMask', [30 50, 60 60], 'pupilGammaCorrection',1,'pupilRange',[30 50]*2, 'pupilCircleThresh', 0.03 ...
    'exponentialTauParams', [.25, .25, 10, 1, 1],  'likelihoodErrorExponent',[1.25 1.25 2 2 2]};
...
customKeyValue1 = {'rfMRI_REST_*', ...
    ...
    'pupilFrameMask', [40 30], 'pupilRange',[40 150]*2, 'pupilCircleThresh', 0.04, ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue2 = {'GazeCal*', ...
    'glintFrameMask', [65 70 100 120], ...
...
customKeyValue1 = {{'T1*','T2*','dMRI*'}, ...
    ...
    'pupilRange', [30 120]*2, 'pupilCircleThresh', 0.07,...
    'cutErrorThreshold',13};
customKeyValue2 = {'rfMRI_REST_*', ...
    'glintFrameMask', [70 100 110 80], ...
    'pupilRange', [50 150]*2, 'pupilCircleThresh', 0.06, 'glintGammaCorrection',3.5, ...
...
customKeyValue1 = {'GazeCal', ...
    'pupilRange', [20 120]*2, 'pupilCircleThresh', 0.03, 'pupilGammaCorrection', .5, ...
    'glintFrameMask', [20 90 70 80]};
customKeyValue2 = {'rfMRI_REST_*', ...
    'pupilRange', [20 200]*2, 'pupilCircleThresh', 0.03, ...
    'exponentialTauParams', [.25, .25, 10, 1, 1], ...
