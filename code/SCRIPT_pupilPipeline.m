...
% 
% 1. all videos have already gone through the `raw2gray` stage. This is to
% save both processing time and hard drive space on analysis machines,
% since the gray videos are much smaller than the raw ones. The raw2gray
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [20 90], 'pupilCircleThresh', 0.035, 'gammaCorrection', .50, ...
    'useLowResSizeCalVideo',true,'skipStage', {'raw2gray'});

% TOME_3002 session1
pathParams.subjectID = 'TOME_3002';
pathParams.sessionDate = '082616';
customKeyValue1 = {'T1','pupilRange', [30 90], 'pupilCircleThresh', 0.03, 'gammaCorrection', .5};
customKeyValue2 = {'rfMRI_REST_*','pupilRange', [30 200], 'pupilCircleThresh', 0.03, 'gammaCorrection', .1};
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [30 100], 'pupilCircleThresh', 0.05, 'gammaCorrection', .5, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [30 100], 'pupilCircleThresh', 0.04, 'gammaCorrection', .5, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [10 120], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [20 180], 'pupilCircleThresh', 0.06, 'gammaCorrection', .5, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [10 90], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'raw2gray'});

% TOME_3011 session1
pathParams.subjectID = 'TOME_3011';
pathParams.sessionDate = '111116';
customKeyValue1 = {'T1','pupilRange', [40 120], 'pupilCircleThresh', 0.07, 'gammaCorrection', .75};
customKeyValue2 = {'rfMRI_REST_*', 'pupilRange', [50 150], 'pupilCircleThresh', 0.06, 'gammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [30 280], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75, ...
    'skipStage', {'raw2gray'});
...
customKeyValue1 = {'*Cal*', 'pupilRange', [10 180], 'pupilCircleThresh', 0.05, 'gammaCorrection', .75};
customKeyValue2 = {'T*_*', 'pupilRange', [30 200], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
customKeyValue3 = {'dMRI_*', 'pupilRange', [10 200], 'pupilCircleThresh', 0.04, 'gammaCorrection', 1};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
customKeyValue1 = {'*Cal*', 'pupilRange', [5 180], 'pupilCircleThresh', 0.06, 'gammaCorrection', 1};
...
customKeyValue1 = {'*Cal*', 'pupilRange', [5 120], 'pupilCircleThresh', 0.04, 'gammaCorrection', 1};
customKeyValue2 = {'T*_*', 'pupilRange', [30 150], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValue3 = {'rfMRI_REST_*', 'pupilRange', [30 150], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
customKeyValue1 = {'*Cal*', 'pupilRange', [10 100], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValue2 = {'dMRI_*', 'pupilRange', [10 100], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValue3 = {'rfMRI_REST_*', 'pupilRange', [10 200], 'pupilCircleThresh', 0.05, 'gammaCorrection', .5};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
customKeyValue1 = {'*Cal*', 'pupilRange', [10 100], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValue2 = {'dMRI_*', 'pupilRange', [10 100], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValue3 = {'rfMRI_REST_*', 'pupilRange', [10 140], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [20 180], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75, ...
    'skipStage', {'raw2gray'});
...
customKeyValue1 = {'*Cal*', 'pupilRange', [5 180], 'pupilCircleThresh', 0.05, 'gammaCorrection', .75};
customKeyValue2 = {'T*_*', 'pupilRange', [5 180], 'pupilCircleThresh', 0.05, 'gammaCorrection', .75};
customKeyValue3 = {'dMRI_*', 'pupilRange', [5 180], 'pupilCircleThresh', 0.05, 'gammaCorrection', .75};
%for rfmri(terrible results)
customKeyValue4 = {'rfMRI_REST_*', 'pupilRange', [40 300], 'pupilCircleThresh', 0.04, 'gammaCorrection', .5};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3; customKeyValue4};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
customKeyValue1 = {'*Cal*', 'pupilRange', [10 180], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
%for rfmri(terrible results)
customKeyValue2 = {'rfMRI_REST_*', 'pupilRange', [10 180], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
customKeyValue1 = {'*Cal*', 'pupilRange', [10 180], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
customKeyValue2 = {'T*_*', 'pupilRange', [5 180], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValue3 = {'dMRI_*', 'pupilRange', [5 180], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
%for rfmri(nothing better)
customKeyValue4 = {'rfMRI_REST_*', 'pupilRange', [30 400], 'pupilCircleThresh', 0.04, 'gammaCorrection', 1};
customKeyValues = {customKeyValue1; customKeyValue2; customKeyValue3; customKeyValue4};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
pathParams.sessionDate = '081916';
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [10 250], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75, ...
    'useLowResSizeCalVideo',true,'skipStage', {'raw2gray'});
...
pathParams.subjectID = 'TOME_3004';
pathParams.sessionDate = '101416';
customKeyValue1 = {'*Cal*', 'pupilRange', [10 250], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
customKeyValue2 = {'tfMRI_*', 'pupilRange', [10 180], 'pupilCircleThresh', 0.03, 'gammaCorrection', .5};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [20 180], 'pupilCircleThresh', 0.07, 'gammaCorrection', .5, ...
    'useLowResSizeCalVideo',true,'skipStage', {'raw2gray'});

%TOME_3007 session2
pathParams.subjectID = 'TOME_3007';
pathParams.sessionDate = '101716';
customKeyValue1 = {'*Cal*', 'pupilRange', [20 140], 'pupilCircleThresh', 0.02, 'gammaCorrection', .5};
customKeyValue2 = {'tfMRI_*', 'pupilRange', [30 260], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
customKeyValue1 = {'*Cal*', 'pupilRange', [30 260], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
customKeyValue2 = {'tfMRI_*', 'pupilRange', [30 260], 'pupilCircleThresh', 0.04, 'gammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
...
customKeyValue1 = {'*Cal*', 'pupilRange', [10 250], 'pupilCircleThresh', 0.05, 'gammaCorrection', .75};
customKeyValue2 = {'tfMRI_*', 'pupilRange', [30 250], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [10 250], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75, ...
    'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [30 250], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75, ...
    'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [10 200], 'pupilCircleThresh', 0.05, 'gammaCorrection', 1, ...
    'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [10 200], 'pupilCircleThresh', 0.02, 'gammaCorrection', 1, ...
    'skipStage', {'raw2gray'});

%TOME_3017 session2
pathParams.subjectID = 'TOME_3017';
pathParams.sessionDate = '033117';
customKeyValue1 = {'*Cal*', 'pupilRange', [10 200], 'pupilCircleThresh', 0.02, 'gammaCorrection', 1};
customKeyValue2 = {'tfMRI_*', 'pupilRange', [10 180], 'pupilCircleThresh', 0.03, 'gammaCorrection', .75};
customKeyValues = {customKeyValue1; customKeyValue2};
pupilPipelineWrapper(pathParams, ...
    'skipStage', {'raw2gray'}, ...
    'customKeyValues', customKeyValues);
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [30 60], 'pupilCircleThresh', 0.02, 'gammaCorrection', .3, ...
    'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [20 120], 'pupilCircleThresh', 0.04, 'gammaCorrection', 1.5, ...
    'skipStage', {'raw2gray'});
...
pupilPipelineWrapper(pathParams, ...
    'pupilRange', [20 90], 'pupilCircleThresh', 0.04, 'gammaCorrection', 1.5, ...
    'skipStage', {'raw2gray'});
