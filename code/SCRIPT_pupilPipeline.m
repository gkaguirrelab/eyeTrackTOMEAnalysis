...
customKeyValue4 = {{'dMRI_dir98_PA*','dMRI_dir99_PA*'}, 'glintFrameMask',[65 100 130 100], ...
    'pupilGammaCorrection', 1.4,'pupilCircleThresh', 0.05,'maskBox', [0.7 1]};
customKeyValue5 = {'T1_', 'glintFrameMask',[10 70 110 100], ...
    'pupilGammaCorrection', 1.4,'pupilCircleThresh', 0.05,'maskBox', [0.7 1]};
customKeyValue6 = {'T2_','glintFrameMask',[10 70 110 100], ...
    'pupilGammaCorrection', 1.4,'pupilCircleThresh', 0.05,'maskBox', [0.7 1]};
...
customKeyValue4 = {'T1_*', 'glintFrameMask',[85 100 110 100]};
customKeyValue5 = {'T2_*','glintFrameMask',[55 100 140 100]};
