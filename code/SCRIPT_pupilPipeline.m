...
customKeyValue3 = {'rfMRI_REST_AP_run03*', ...
    ...
    'pupilRange', [50 150], 'pupilCircleThresh', 0.08, 'pupilGammaCorrection', 1.1, ...
    'extendBlinkWindow', [5,15], ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue4 = {'rfMRI_REST_PA_run04*', ...
    ...
    'extendBlinkWindow', [5,15], ...
    'exponentialTauParams', [.25, .25, 10, 1, 1]};
customKeyValue5 = {{'LowResScaleCalibration_3Mm*','LowResScaleCalibration_4Mm*'}, 'skipRun', true,...
    'pupilFrameMask', [70 50 90 100], 'pupilGammaCorrection',1,'pupilRange',[40 90]};
customKeyValue6 = {'LowResScaleCalibration_5Mm*', 'skipRun', true, ...
...
pupilPipelineWrapper(pathParams, ...
    'useLowResSizeCalVideo',true, 'skipStage', {'convertRawToGray'}, ...
    'ellipseTransparentUB',[320,240,10000,0.7, 0.5*pi], ...
    'customKeyValues', customKeyValues);
