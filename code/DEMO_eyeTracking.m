...
runVideoPipeline( pathParams, ...
    ...
    'skipStage', {'convertRawToGray', 'fitIrisPerimeter', 'makePupilFitVideo' });
...
runVideoPipeline( pathParams, ...
    ...
    'skipStage', {'convertRawToGray', 'trackGlint', 'extractPupilPerimeter', 'makePreliminaryControlFile', 'correctPupilPerimeter', 'makePupilFitVideo' });
